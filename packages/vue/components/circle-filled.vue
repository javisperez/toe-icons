...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" class="toe-icon ti ti-circle-filled"
    :class="{'spin': spin}" :width="size" :height="size"
    viewBox="0 0 64 64" :fill="color" :stroke="strokeColor"
    :stroke-width="stroke" stroke-linecap="round" stroke-linejoin="round">
    <circle cx="543.992" cy="352" r="14.13" transform="translate(-892.778 -566.387) scale(1.70002)"></circle>
  </svg>
</template>